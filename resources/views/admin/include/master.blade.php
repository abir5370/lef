...
<![endif]-->
		...
		<script src="{{asset('admin-asset')}}/js/jquery.sparkline.index.min.js"></script>
		<script src="{{asset('admin-asset')}}/js/jquery.flot.min.js"></script>
		<script src="{{asset('admin-asset')}}/js/jquery.flot.pie.min.js"></script>
		<script src="{{asset('admin-asset')}}/js/jquery.flot.resize.min.js"></script>

		<!-- ace scripts -->
		<script src="{{asset('admin-asset')}}/js/ace-elements.min.js"></script>
		<script src="{{asset('admin-asset')}}/js/ace.min.js"></script>
		@stack('js')
