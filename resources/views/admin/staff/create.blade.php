...
<div class="main-content-inner font">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Add Staff & Teacher Information</li>
        </ul><!-- /.breadcrumb -->
    </div>
        ...
        <div class="row">
            <div class="col-xs-12">
               ...
               @if($errors->any())
                ...
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" method="POST" action="{{route('staffs.store')}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" id="title" placeholder="Staff title"
                                class="col-xs-12 col-md-11 col-sm-12" />
                            <br> <br>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="social_link" id="social_link" placeholder="Staff Social Link"
                                class="col-xs-12 col-md-11 col-sm-12" />
                            <br> <br>
                        </div>
                    </div>
