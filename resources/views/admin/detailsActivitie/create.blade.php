...
<div class="main-content-inner font">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">Add Activitie & Program Information</li>
        </ul><!-- /.breadcrumb -->
    </div>
    ...
    <div class="page-content font">
        ...
        <div class="row">
            <div class="col-xs-12">
               ...
               @endif
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" method="POST" action="{{route('activitieprograms.store')}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" id="name" placeholder="Activitie Name / Title "
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="icon" placeholder="Activitie Icon"
                                class="col-xs-12 col-md-11 col-sm-12" />
                            <br> <br>
                        </div>
                    </div>
