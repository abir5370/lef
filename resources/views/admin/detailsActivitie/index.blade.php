...
<div class="container font">
    ...
    ?>
    <h3 class="header smaller lighter blue d-inline">All Products ({{ $activitieProgramsCount }})</h3> 
    <!-- div.dataTables_borderWrap -->
    <div>
        <form class="col-md-offset-3 text-right">
            <a href="{{route('activitieprograms.create')}}" class="align-items-center btn btn-theme">
