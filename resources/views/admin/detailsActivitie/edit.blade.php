    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="{{route('activitieprograms.index')}}">Activitie & Program</a>
            </li>
            <li class="active">Edit Activitie & Program Information</li>
        </ul><!-- /.breadcrumb -->
    </div>
    ...
    <div class="page-content font">
        ...
        <div class="row">
            <div class="col-xs-12">
               ...
               @endif
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" method="POST" action="{{route('activitieprograms.update',$activitieprogram->id)}}"
                    enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    {{-- activitie title  --}}
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="slider_name">Activitie Name / Title :</label>

                        <div class="col-sm-9">
                            <input type="text" name="title" value="{{$activitieprogram->title}}" id="name" placeholder="Activitie Name / Title "
                    ...
                    {{-- activitie icon  --}}
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right">Activitie Icon :</label>

                        <div class="col-sm-9">
                            <input type="text" name="icon" value="{{$activitieprogram->icon}}" placeholder="Activitie Icon"
                                class="col-xs-12 col-md-11 col-sm-12" />
                            <br> <br>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="description" name="details" placeholder="Write details" class="col-xs-12 col-md-11 col-sm-12"
                                style="height: 150px; width: 92%;">{{$activitieprogram->details}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <img height="145" id="blah" width="155" src="{{ asset('images/activitieprogram/'.$activitieprogram->image) }}"
                                        alt="Slider Image">
                                </label>
                            </span>
                            @error('image')
