    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="{{route('boardmembers.index')}}">Member List</a>
            </li>
        ...
        <div class="row">
            <div class="col-xs-12">
               ...
               @if($errors->any())
                ...
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" method="POST" action="{{route('boardmembers.update',$staff->id)}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{$staff->name}}" id="name" placeholder="Name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" value="{{$staff->title}}" id="title" placeholder="title"
                                class="col-xs-12 col-md-11 col-sm-12" />
                            <br> <br>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{$staff->social_link}}" name="social_link" id="social_link" placeholder="Social Link"
                                class="col-xs-12 col-md-11 col-sm-12" />
                            <br> <br>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle"">
                                    <img height="145" id="blah" width="155" src="{{ asset('images/boardMember/'.$staff->image) }}"
                                        alt="Image">
                                </label>
                            </span>
                            @error('image')
