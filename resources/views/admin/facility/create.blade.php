    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="{{route('facilities.index')}}">Facility</a>
            </li>
            <li class="active">Add Facilities Information</li>
        </ul><!-- /.breadcrumb -->
    </div>
    @if ($errors->any())
    ...
    <div class="page-content font">
        ...
        <div class="row">
            <div class="col-xs-12">
               ...
               @endif
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" method="POST" action="{{route('facilities.store')}}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" id="name" placeholder="Facility Title "
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="icon" id="name" placeholder="Icon "
                                class="col-xs-12 col-md-11 col-sm-12" />
                            <br> <br>
                        </div>
                    </div>
