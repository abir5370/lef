            ...
            <div class="widget-header">
                <div class="row">
                    <div class="col-md-6 col-6 col-xs-6">
                        <h4 class="widget-title">Edit Success Story</h4>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center" style="margin-top: 15px; margin-left: 10px;">
                    <form action="{{route('oursuccess.update',$success->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                     {{-- Donar name  --}}
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{$success->name}}" id="name" placeholder="Donar Name"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            class="col-xs-12 col-md-11 col-sm-12"
                            style="height: 80px; width: 92%;">{{$success->details}}</textarea>
                            <br> <br>
                            <span>
                                @error('details')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle"">
                                    <img height="145" id="blah" width="155" src="{{ asset('images/success/'.$success->image) }}"
                                        alt="Image">
                                </label>
                            </span>
                            @error('image')
