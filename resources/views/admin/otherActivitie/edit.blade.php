    ...
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
            <li>
                ...
                <a href="{{route('activitieothers.index')}}"> Other Activitie</a>
            </li>
            <li class="active">Edit Other Activitie Information</li>
        </ul><!-- /.breadcrumb -->
    </div>
    @if ($errors->any())
    ...
    <div class="page-content font">
        ...
        <div class="row">
            <div class="col-xs-12">
               ...
               @endif
                <!-- PAGE CONTENT BEGINS -->
                <form class="form-horizontal" role="form" method="POST" action="{{route('activitieothers.update',$activitieOther->id)}}"
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="slider_name">Activitie Name :</label>

                        <div class="col-sm-9">
                            <input type="text" name="name" value="{{$activitieOther->name}}" id="name" placeholder="Activitie Name "
                    ...
                    {{-- activitie title  --}}
                    <div class="form-group">
                        <label class="col-sm-3 control-label no-padding-right" for="slider_name">Activitie Title :</label>

                        <div class="col-sm-9">
                            <input type="text" name="title"  value="{{$activitieOther->title}}" id="name" placeholder="Activitie Title "
                                class="col-xs-12 col-md-11 col-sm-12" />
                            <br> <br>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="description" name="details" placeholder="Write details" class="col-xs-12 col-md-11 col-sm-12"
                                style="height: 150px; width: 92%;">{{$activitieOther->details}}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span class="help-inline col-xs-12 col-sm-7">
                                <label class="middle">
                                    <img height="145" id="blah" width="155" src="{{ asset('images/activitieOther/' . $activitieOther->image) }}"
                                        alt="Slider Image">
                                </label>
                            </span>
                            @error('image')
